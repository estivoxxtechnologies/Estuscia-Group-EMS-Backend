        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedDays = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    MedicalCertificateFileUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    MedicalCertificateFileName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_TenantBranches_TenantId_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_TenantId_BranchId_Status",
                table: "LeaveRequests",
                columns: new[] { "TenantId", "BranchId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_TenantId_BranchId_UserId_StartDate_EndDate",
                table: "LeaveRequests",
                columns: new[] { "TenantId", "BranchId", "UserId", "StartDate", "EndDate" });
