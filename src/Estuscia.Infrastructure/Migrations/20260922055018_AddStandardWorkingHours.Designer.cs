...
namespace Estuscia.Infrastructure.Migrations
{
    ...
    [Migration("20260922055018_AddStandardWorkingHours")]
    partial class AddStandardWorkingHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estuscia.Domain.Entities.DeveloperWork", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estuscia.Domain.Entities.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MedicalCertificateFileUrl")
                        .HasMaxLength(1000)
                    ...
                    b.HasIndex("TenantId", "BranchId", "UserId", "StartDate", "EndDate");
            ...
            modelBuilder.Entity("Estuscia.Domain.Entities.LeaveRequest", b =>
                {
                    b.HasOne("Estuscia.Domain.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Estuscia.Domain.Entities.ApplicationUser", "ReviewedByUser")
                        .WithMany()
